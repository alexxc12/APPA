        ...
        <div class="contenedor-principal">
            <div class="info-publicacion">
                ...
                <section class="compartir">
                    ...
                    <a href="http://facebook.com/sharer.php?u=http://localhost/sapi/publicacion.php?idPublicacion=<?php echo $propiedad['id'] ?>" target="_blank">📘</a>
                    <a href="whatsapp://send?text=http://paulopelegrina.com/publicacion.php?idPublicacion=<?php echo $propiedad['id'] ?>" data-action="share/whatsapp/share"> 📱 </a>
                </section>
            </div>
